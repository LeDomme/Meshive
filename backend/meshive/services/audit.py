...
class AuditAction:
    CREATOR_PROFILE_CREATED = "creator_profile.created"
    CREATOR_PROFILE_UPDATED = "creator_profile.updated"
    ...
    USER_SOURCE_ACCESS_CHANGED = "user.source_access_changed"
    ...
    MODEL_PRIMARY_IMAGE_SET = "model.primary_image_set"
    MODEL_RESCAN_QUEUED = "model.rescan_queued"
    MODEL_IMAGE_REBUILD_QUEUED = "model.image_rebuild_queued"
    MODEL_IMAGES_RESET = "model.images_reset"
    MODEL_MISSING_DELETED = "model.missing_deleted"
